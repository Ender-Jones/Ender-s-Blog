...
The bad news first: at coding, **Gemini has started to drool** — still ahead of part of the domestic pack, though not of its front-runners; more on that at the end.
...
Images are decent, and video is nearly effortless, since YouTube lives in the same house. As a partner for talking through ideas, **an eight out of ten. For code, no.**
...
Disclosure before the complaints: they are personal, and for most people **GPT remains the right pick** — absent a hard reason against it, choose it and you will be fine. It has real advantages in compute, cost and price, and codex has been doing honest work lately.
...
3.  Its front-end work is weak and its taste sometimes loses to Gemini — and since most of the world writes its front-ends with GPT, everything ends up looking the same, which makes it worse.
...
Claude is **my personal favorite**, and I say so with both eyes open: tokens are brutally expensive, the limits on Fable are tight, and more than one of the company's choices I actively dislike. But the work is the work.
