...
**印 要做的**
1. 翻译 `src/content/posts/zh/` 4 篇(建议顺序: 研究笔记 → prompt 随笔 → who-am-i; 诗可豁免); 顺便定 research 页要不要中文(倾向: 不要).
...
**机器侧(待触发)**
4. 部署第二阶段: D1 建库 + Access + PAT(截图级步骤, 想做时说)→ console 前端从 LOCAL MODE 切到 `/api`.
